...
${OBJECTDIR}/config/MPIGameConfig.o: config/MPIGameConfig.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/config/MPIGameConfig.o config/MPIGameConfig.cpp

${OBJECTDIR}/config/Utils.o: config/Utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/config
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/config/Utils.o config/Utils.cpp
...
${OBJECTDIR}/control/MPIGameMain.o: control/MPIGameMain.cpp 
	${MKDIR} -p ${OBJECTDIR}/control
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -Iconfig -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/control/MPIGameMain.o control/MPIGameMain.cpp

${OBJECTDIR}/model/Action.o: model/Action.cpp 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -Iconfig -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/Action.o model/Action.cpp

${OBJECTDIR}/model/Character.o: model/Character.cpp 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -Iconfig -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/Character.o model/Character.cpp

${OBJECTDIR}/model/Facing.o: model/Facing.cpp 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -Iconfig -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/Facing.o model/Facing.cpp

${OBJECTDIR}/model/Movement.o: model/Movement.cpp 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -Iconfig -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/Movement.o model/Movement.cpp

${OBJECTDIR}/model/NPC.o: model/NPC.cpp 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -Iconfig -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/NPC.o model/NPC.cpp

${OBJECTDIR}/model/Player.o: model/Player.cpp 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -Iconfig -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/Player.o model/Player.cpp

${OBJECTDIR}/model/Position.o: model/Position.cpp 
	${MKDIR} -p ${OBJECTDIR}/model
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../mpich_install/include -Imodel -Iinclude/ -Iconfig -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/model/Position.o model/Position.cpp
